    ...
    return (
      <div>
        <form onSubmit={(e)=>this.addQuestion(e)}>
			  <p>Вопрос:</p>
			  <textarea className="form-control" name="question" onChange={this.handleChange} rows="5" required/>
			  <p>Правильный ответ:</p>
			  <textarea className="form-control" name="answer"  onChange={this.handleChange} rows="5" required/>
